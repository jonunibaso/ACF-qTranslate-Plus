...
class acf_field_ppqtranslate_image extends acf_field_image
{

	function __construct()
	{
		$this->name = 'ppqtranslate_image';
	...
	function create_field($field)
	{
		...
		$currentLanguage = ppqtrans_getLanguage();
...
new acf_field_ppqtranslate_image();

...
class acf_field_ppqtranslate_wysiwyg extends acf_field_wysiwyg
{

	function __construct()
	{
		$this->name = 'ppqtranslate_wysiwyg';
	...
	function render_field($field)
	{
  	...
  	function input_form_data( $args ) {
		...
		(function($) {
			...
			acf.fields.ppqtranslate_wysiwyg.toolbars = <?php echo json_encode( $json ); ?>;
...
new acf_field_ppqtranslate_wysiwyg;

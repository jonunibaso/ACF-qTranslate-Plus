...
add_action('acf/input/admin_enqueue_scripts', 'acf_ppqtranslate_v5_admin_enqueue_scripts');
function acf_ppqtranslate_v5_admin_enqueue_scripts() {
	if (acf_ppqtranslate_acf_major_version() === 5) {
...
add_action('acf/include_field_types', 'acf_ppqtranslate_plugin_v5_include_field_types');
function acf_ppqtranslate_plugin_v5_include_field_types($version) {
...
add_filter('acf/format_value', 'acf_ppqtranslate_plugin_v5_format_value');
function acf_ppqtranslate_plugin_v5_format_value($value) {
